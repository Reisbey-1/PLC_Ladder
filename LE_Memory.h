// LE_Memory.h: Schnittstelle für die Klasse CLE_Memory.
//
//////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////
// MEMORY
...
//////////////////////////////////////////////////////////////////////
//
#if !defined(LE_MEMORY_H_9_B4_INCLUDED_)
#define LE_MEMORY_H_9_B4_INCLUDED_

#include "LadderElement.h"
namespace LadderDll
{
	class LADDER_API CLE_Memory : public CLadderElement  
	{
	public:
		CLE_Memory();
		virtual ~CLE_Memory();
...
//		virtual void HighLight(CDC& DC, CgxDrawer* pDrawer, CCell origin = CCell(0,0));
	...
	private:
		...
		DECLARE_SERIAL(CLE_Memory)		
	};


} // name space
#endif // !defined(LE_MEMORY_H_9_B4_INCLUDED_)
